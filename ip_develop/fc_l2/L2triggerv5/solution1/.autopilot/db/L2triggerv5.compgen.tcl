...
set id 1
set name L2triggerv5_dadd_64ns_64ns_64_9_full_dsp
...
set id 3
set name L2triggerv5_dmul_64ns_64ns_64_10_max_dsp
...
set id 5
set name L2triggerv5_uitodp_32ns_64_8
...
set id 7
set name L2triggerv5_dsqrt_64ns_64ns_64_59
...
set ID 9
set MemName L2triggerv5_sum_overP1
...
# Memory (RAM/ROM)  definition:
set ID 10
set MemName L2triggerv5_data_shift1
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 17
set AddrRange 9216
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 11 \
			corename L2triggerv5_CTRL_BUS_axilite \
			name L2triggerv5_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler L2triggerv5_CTRL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream_TDATA { I 32 vector } in_stream_TVALID { I 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_trig_data \
    op interface \
    ports { trig_data { O 32 vector } trig_data_ap_vld { O 1 bit } } \
} "
}
