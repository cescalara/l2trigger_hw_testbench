...
if {[file isfile L2triggerv5.autotvin.dat]} {
	file delete -force L2triggerv5.autotvin.dat
}

if {[file isfile L2triggerv5.autotvout.dat]} {
	file delete -force L2triggerv5.autotvout.dat
}
